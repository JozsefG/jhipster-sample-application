...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.XGroup.class.getName() + ".xusers", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.XUser.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.XUser.class.getName() + ".xgroups", jcacheConfiguration);
